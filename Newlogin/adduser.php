...
<form action="adduser2.php" name="form_signup" id="form_signup" method="post" onSubmit="return validate()">
  <table width="545" height="373" border="0">
    <tr>
      ...
      <td width="348">
        <label>
          <input type="text" name="fullname" id="fullname" onBlur="onlyalphabate(document.getElementById('fullname'))" placeholder="eg: Dilani Famalka Dehipe"/>
     ...
     <tr>
      ...
      <td width="348">
        <label>
          <input type="text" name="employnum" id="employnum" onBlur="validate_empno(document.getElementById('employnum'))" placeholder="eg: ITOF001"/>
    ...
    <tr>
      ...
      <td>
        <label>
          <input type="text" name="username" id="username" onBlur="validate_un(document.getElementById('username'))" placeholder="eg: dilani001"/>
    ...
    <tr>
      ...
      <td>
        <label>
          <input type="password" name="password" id="password" onBlur="validate_pw(document.getElementById('password'))" placeholder="eg: X34hn7*"/>
