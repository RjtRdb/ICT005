...
echo '<table width="350" border="1" cellpadding="1">';
							...
							echo "<tr>"."<td><b>"."Fullname"."</b></td><td><b>"."EmployNumber"."</b></td><td><b>"."Phone"."</b></td><td><b>"."Email"."</b></td><td><b>"."Username"."</b></td><td><b>"."Level"."</b></td><td><b>"."Edit"."</b></td><td><b>"."Delete"."</b></td></tr>";
						  	while ($row= mysql_fetch_array($qry))
							{
								$x=$row["employnumber"];
								echo "<tr>"."<td>".$row['fullname']."</td><td>".$row['employnumber']."</td><td>".$row['phone']."</td><td>".$row['email']."</td><td>".$row['username']."</td><td>".$row['level']."</td><td><a href='edituser22.php?id=$x'>".edit."</td>
